...
/***/ function(module, exports, __webpack_require__) {
	...
	var _v = __webpack_require__(165);
	...
	var _FileList = __webpack_require__(169);

	var _FileList2 = _interopRequireDefault(_FileList);

	var _UploadBox = __webpack_require__(170);
	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(Storage, null)
	      );
	    }
	  }]);
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('img', { alt: 'icon', src: '../static/icon.png' })
	        ),
	        _react2.default.createElement(
	          'a',
	...
	var Storage = function (_React$Component2) {
	  _inherits(Storage, _React$Component2);

	  function Storage(props) {
	    _classCallCheck(this, Storage);

	    var _this2 = _possibleConstructorReturn(this, (Storage.__proto__ || Object.getPrototypeOf(Storage)).call(this, props));

	    _this2.getLocalPersistentState = _this2.getLocalPersistentState.bind(_this2);
	    _this2.onDrop = _this2.onDrop.bind(_this2);
	    _this2.onDelete = _this2.onDelete.bind(_this2);
	    _this2.onLoadChooser = _this2.onLoadChooser.bind(_this2);
	    _this2.onLoadLocal = _this2.onLoadLocal.bind(_this2);
	    _this2.onCloseFailedUploadAlert = _this2.onCloseFailedUploadAlert.bind(_this2);

	    _this2.showAlertAndRenameFiles = _this2.showAlertAndRenameFiles.bind(_this2);
	    _this2.renameDuplicateFiles = _this2.renameDuplicateFiles.bind(_this2);
	    _this2.storeFileToAzure = _this2.storeFileToAzure.bind(_this2);
	    _this2.storeFileDataToState = _this2.storeFileDataToState.bind(_this2);

	    var localPersistentState = _this2.getLocalPersistentState();
	  ...
	  _createClass(Storage, [{
	    key: 'getLocalPersistentState',
	    value: function getLocalPersistentState() {
	      {/* Retrieve state values from previous sessions stored
	           on localStorage using store.js library */}
	      var acceptedFilesData = _store2.default.session.get('acceptedFilesData') ? _store2.default.session.get('acceptedFilesData') : [];

	      var userID = _store2.default.session.get('userID') ? _store2.default.session.get('userID') : (0, _v2.default)();
	      _store2.default.session.set('userID', userID);
	    ...
	    value: function onLoadLocal(e) {
	      ...
	      try {
	        for (var _iterator = nonMappableFileList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    ...
	    key: 'showAlertAndRenameFiles',
	    value: function showAlertAndRenameFiles(acceptedFiles) {
	      this.setState({
	        isUploading: true
	      });
	      this.renameDuplicateFiles(acceptedFiles);
	    ...
	    key: 'renameDuplicateFiles',
	    value: function renameDuplicateFiles(acceptedFiles) {
	      {/* Resolve all potential naming collisions between uploaded
	           files and files the user wants to upload */}
	      var req = _superagent2.default.post('/rename_duplicates');
	      req.set('Content-Type', 'application/json').send({
	        ...
	        'newFilesData': acceptedFiles.map(function (file) {
	          var size = 'size' in file ? (file.size / 1000000).toFixed(2) : (file.bytes / 1000000).toFixed(2);
	          return {
	            'name': file.name,
	            'size': size
	          };
	    ...
	    key: 'storeFileToAzure',
	    value: function storeFileToAzure(acceptedFiles, error, response) {
	      ...
	      var filenameList = response.body.filesData.map(function (file) {
	        return file.name;
	      });
	      filenameList = filenameList.slice(oldLength, newLength);
	      var fileUrlList = acceptedFiles.map(function (file) {
	        return file.link;
	      });
	      ...
	      if ('size' in acceptedFiles[0]) {
	        ...
	        req.set('UserID', this.state.userID).set('Content-Disposition', 'attachment');
	        ...
	        var req = _superagent2.default.post('/download_from_dropbox_and_store');
	        req.set('UserID', this.state.userID).set('Content-Type', 'application/json').send({
	    ...
	    key: 'storeFileDataToState',
	    value: function storeFileDataToState(newAcceptedFilesData, error, response) {
	      ...
	      _store2.default.session.set('acceptedFilesData', newAcceptedFilesData);
	    }
	  }, {
	    key: 'onDelete',
	    value: function onDelete(fileData, e) {
	      ...
	      var req = _superagent2.default.post('/delete');
	      req.set('UserID', this.state.userID).set('Content-Type', 'application/json').send({ 'filename': this.state.acceptedFilesData[fileIndex].name }).end(function (err, res) {
	        console.log(res.statusText);
	      });

	      var newAcceptedFilesData = this.state.acceptedFilesData.filter(function (_, index) {
	    ...
	    key: 'onCloseFailedUploadAlert',
	    value: function onCloseFailedUploadAlert() {
	      this.setState({
	        rejectedFilesData: []
	      });
	    }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(FailedUploadAlert, {
	          rejectedFilesData: this.state.rejectedFilesData,
	          onCloseAlert: this.onCloseFailedUploadAlert }),
	        _react2.default.createElement(_UploadBox2.default, { onDrop: this.onDrop, userID: this.state.userID,
	          onLoadChooser: this.onLoadChooser,
	          onLoadLocal: this.onLoadLocal }),
	        _react2.default.createElement(SuccessUploadAlert, { isUploading: this.state.isUploading }),
	        _react2.default.createElement(_FileList2.default, { acceptedFilesData: this.state.acceptedFilesData,
	...
	Storage.propTypes = {
	  acceptedFilesData: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object),
	  rejectedFilesData: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object),
	  userID: _react2.default.PropTypes.string,
	  isUploading: _react2.default.PropTypes.bool
	};

	var SuccessUploadAlert = function (_React$Component3) {
	  _inherits(SuccessUploadAlert, _React$Component3);

	  function SuccessUploadAlert(props) {
	    _classCallCheck(this, SuccessUploadAlert);

	    return _possibleConstructorReturn(this, (SuccessUploadAlert.__proto__ || Object.getPrototypeOf(SuccessUploadAlert)).call(this, props));
	  }

	  _createClass(SuccessUploadAlert, [{
	    key: 'render',
	    value: function render() {
	      if (this.props.isUploading === true) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'SuccessUploadAlert' },
	          'Uploading files...'
	        );
	      } else {
	        return null;
	  ...
	  return SuccessUploadAlert;
	}(_react2.default.Component);

	var FailedUploadAlert = function (_React$Component4) {
	  _inherits(FailedUploadAlert, _React$Component4);

	  function FailedUploadAlert(props) {
	    _classCallCheck(this, FailedUploadAlert);

	    return _possibleConstructorReturn(this, (FailedUploadAlert.__proto__ || Object.getPrototypeOf(FailedUploadAlert)).call(this, props));
	  }

	  _createClass(FailedUploadAlert, [{
	    key: 'render',
	    value: function render() {
	      ...
	      var rejectedFilenames = rejectedFilesData.map(function (fileData) {
	        return fileData.name;
	      });
	      if (rejectedFilesData && rejectedFilesData.length > 0) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'FailedUploadAlert' },
	          _react2.default.createElement(
	            'button',
	            { type: 'button', className: 'close' },
	            _react2.default.createElement(
	              'span',
	              { onClick: this.props.onCloseAlert, 'aria-hidden': 'true' },
	              '\xD7'
	            )
	          ),
	          'Sorry! ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileList = function FileList(props) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'FileList table-responsive' },
	    _react2.default.createElement(
	      'table',
	      { className: 'table' },
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('th', { className: 'delete-cross' })
	        )
	      ),
	      _react2.default.createElement(
	        'tbody',
	        null,
	        props.acceptedFilesData.map(function (fileData, index) {
	          return _react2.default.createElement(File, { fileData: fileData, userID: props.userID,
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { target: '_blank', href: viewerUrl + userPath },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { target: '#', onClick: this.props.onDelete.bind(this, this.props.fileData) },
	            '\xD7'
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UploadBox = function UploadBox(props) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'UploadBox' },
	    _react2.default.createElement(PickerBar, { onLoadLocal: props.onLoadLocal, onLoadChooser: props.onLoadChooser }),
	    _react2.default.createElement(
	      _reactDropzone2.default,
	      { className: 'Dropzone', accept: 'application/pdf', onDrop: props.onDrop },
	      _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          'span',
	          null,
	          ' Drag and drop PDFs or click the box to upload '
	        )
	      )
	    )
	  );
	...
	var PickerBar = function PickerBar(props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'PickerBar btn-group', role: 'group', 'aria-label': '...' },
	    _react2.default.createElement(ComputerPicker, { onLoadLocal: props.onLoadLocal }),
	    _react2.default.createElement(DropboxPicker, { onLoadChooser: props.onLoadChooser })
	  );
	};

	var ComputerPicker = function ComputerPicker(props) {
	  return _react2.default.createElement(
	    'label',
	    { className: 'ComputerPicker btn btn-default btn-file' },
	    'Computer ',
	    _react2.default.createElement('input', { type: 'file', onChange: props.onLoadLocal, accept: '.pdf', multiple: true })
	  );
	};

	var DropboxPicker = function DropboxPicker(props) {
	  return _react2.default.createElement(
	    'button',
	    { type: 'button', className: 'btn btn-default', onClick: props.onLoadChooser },
	    'Dropbox'
	  );
	};
